...
- Guard rules and carve-out reasoning: `docs/designs/2026-07-10-safety-core-remediation-design.md` (Artifact Destination Guard section; review finding F1 closed).
