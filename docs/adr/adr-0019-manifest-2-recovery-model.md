...
- The full wire model, adjudication table, and worked apply → interrupted resume → interrupted restore → convergent re-run example live in the approved design: `docs/specs/2026-07-10-safety-core-remediation-design.md` (reviewed through five adversarial rounds, F1–F8 closed).
