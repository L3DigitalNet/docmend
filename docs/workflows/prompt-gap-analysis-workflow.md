...
- Perform follow-up internet research using `/qdev:research` to provide evidence-backed recommendations for each gap, and document findings in `docs/research/` as well as summaries in the `open-questions.md` and `deep-research-queue.md` files.
